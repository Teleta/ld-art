...
<!-- NEW: row -->
<tr>
<td style="text-align: justify; text-indent: 15px;">{e.description}</td>
</tr>
<tr><td style="border-width: 0px;">( {e.location} )</td></tr>
<tr><td style="border-width: 0px; white-space:nowrap; font-style: italic;">{e.date_total}</td></tr>
<!-- END: row -->
</table>
</td>
...
<!-- NEW: page --><td><a href="/exhibitions/{p.num}/">{p.name}</a></td><!-- END: page -->
